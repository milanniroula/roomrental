        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormaliseName = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdPost", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdPost_AdTypes_AdTypeId",
                        column: x => x.AdTypeId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdPost_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdPost_AdTypeId",
                table: "AdPost",
                column: "AdTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_AdPost_CategoryId",
                table: "AdPost",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_AdPost_OwnerId",
                table: "AdPost",
                column: "OwnerId");
